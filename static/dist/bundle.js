...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_todoApp2.default, window.devToolsExtension ? window.devToolsExtension() : undefined);
	...
	store.dispatch((0, _todoActions.addTodo)('Text 1'));
	store.dispatch((0, _todoActions.addTodo)('Text 2'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _VisibleTodoList = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var matchDispatchToProps = function matchDispatchToProps(dispatch) {
		return {
			onTodoCompleted: function onTodoCompleted(id) {
				return dispatch((0, _todoActions.completeTodo)(id));
			}
		};
	};

	exports.default = (0, _reactRedux.connect)(matchStateToProps, matchDispatchToProps)(_TodoList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = function TodoList(_ref) {
		...
		var onTodoCompleted = _ref.onTodoCompleted;
		return _react2.default.createElement(
			'div',
			null,
			todos.map(function (todo) {
				return _react2.default.createElement(_Todo2.default, _extends({ key: todo.id }, todo, { onTodoCompleted: onTodoCompleted }));
			})
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function completeTodo(id) {
		return {
			type: _actionTypes.COMPLETE_TODO,
			id: id
		};
	}
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				{ onSubmit: function onSubmit(event) {
						event.preventDefault();
						dispatch((0, _todoActions.addTodo)(text));
					} },
	...
	function todoApp() {
		...
		switch (action.type) {
			...
			case _actionTypes.COMPLETE_TODO:
				...
				return Object.assign({}, state, {
					todos: [].concat(_toConsumableArray(state.todos.slice(0, index)), [Object.assign({}, state.todos[index], {
						completed: true
					})], _toConsumableArray(state.todos.slice(index + 1)))
				});
